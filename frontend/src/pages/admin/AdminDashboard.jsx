  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        <Link to="/admin/projects/new" style={{ padding: '12px 20px', borderRadius: 10, background: NAVY, color: '#fff', fontWeight: 700, fontSize: 13.5, textDecoration: 'none' }}>+ New project</Link>
        <Link to="/admin/messages" style={{ padding: '12px 20px', borderRadius: 10, border: `1px solid ${LINE}`, background: '#fff', color: NAVY, fontWeight: 700, fontSize: 13.5, textDecoration: 'none' }}>View messages</Link>
      </div>
    </div>
  );
}
